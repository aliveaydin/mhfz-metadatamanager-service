...
describe("UpdateMetadataenrichmentjob", () => {
  let ControllerClass;
  let req;
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/MetadataEnrichmentJob/update-metadataenrichmentjob",
      {
  ...
  it("should initialize controller with correct base properties", () => {
    ...
    expect(instance.options.name).to.equal("updateMetadataenrichmentjob");
