...
const { dbGetDocumenttype } = require("dbLayer");

class GetDocumenttypeManager extends DocumentTypeManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbGetDocumenttype function to get the documenttype and return the result to the controller
    const documenttype = await dbGetDocumenttype(this);
...
module.exports = GetDocumenttypeManager;
